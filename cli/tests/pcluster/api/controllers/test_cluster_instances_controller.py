...
def cfn_describe_stack_mock_response(scheduler="slurm", version="3.0.0"):
    stack_data = {
...
class TestDeleteClusterInstances:
    ...
    def test_malformed_request(self, mocker, client, stack_param, expected_response):
        mocker.patch(
            ...
            assert_that(response.get_json()).is_equal_to(
                {
                    ...
                    " please use the DeleteClusterInstances API with `force` param."
                }
            )
