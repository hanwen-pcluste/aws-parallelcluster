...
class ClusterInstance(Model):
    ...
    def __init__(self, instance_id=None, instance_type=None, launch_time=None, private_ip_address=None, public_ip_address=None, state=None, node_type=None, queue_name=None, pool_name=None):  # noqa: E501
