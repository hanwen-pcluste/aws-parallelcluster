        ...
        dna_json = json.dumps(
            {
                "cluster": {
                    ...
                    "raid_shared_dir": get_comma_separated_string(
                        self.shared_storage_mount_dirs[SharedStorageType.RAID]
                    ),
                    "raid_type": get_comma_separated_string(
                    ...
                    "efs_shared_dirs": get_comma_separated_string(
                        self.shared_storage_mount_dirs[SharedStorageType.EFS]
                    ),
                    "fsx_fs_ids": get_shared_storage_ids_by_type(self.shared_storage_infos, SharedStorageType.FSX),
                    "fsx_mount_names": get_comma_separated_string(
                        self.shared_storage_attributes[SharedStorageType.FSX]["MountNames"]
                    ),
                    "fsx_dns_names": get_comma_separated_string(
                        self.shared_storage_attributes[SharedStorageType.FSX]["DNSNames"]
                    ),
                    "fsx_shared_dirs": get_comma_separated_string(
                        self.shared_storage_mount_dirs[SharedStorageType.FSX]
                    ),
                    ...
                    "ebs_shared_dirs": get_comma_separated_string(
                        self.shared_storage_mount_dirs[SharedStorageType.EBS]
                    ),
                    ...
                    Fn.sub(
                        get_user_data_content("../resources/compute_node/user_data.sh"),
                        {
                            **{
                                ...
                                "RAIDSharedDir": get_comma_separated_string(
                                    self._shared_storage_mount_dirs[SharedStorageType.RAID]
                                ),
                                "RAIDType": get_comma_separated_string(
                                ...
                                "EFSSharedDirs": get_comma_separated_string(
                                ...
                                "EbsSharedDirs": get_comma_separated_string(
