        ...
        return batch.CfnJobDefinition.ContainerPropertiesProperty(
            ...
            environment=[
                ...
                batch.CfnJobDefinition.EnvironmentProperty(
                    ...
                    value=get_comma_separated_string(self.shared_storage_mount_dirs[SharedStorageType.EBS]),
                ),
                batch.CfnJobDefinition.EnvironmentProperty(
                    name="PCLUSTER_EFS_SHARED_DIRS",
                    value=get_comma_separated_string(self.shared_storage_mount_dirs[SharedStorageType.EFS]),
                ),
                batch.CfnJobDefinition.EnvironmentProperty(
                ...
                batch.CfnJobDefinition.EnvironmentProperty(
                    ...
                    value=get_comma_separated_string(self.shared_storage_mount_dirs[SharedStorageType.RAID]),
                ),
                batch.CfnJobDefinition.EnvironmentProperty(
