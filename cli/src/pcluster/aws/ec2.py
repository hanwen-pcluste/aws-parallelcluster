...
class Ec2Client(Boto3Client):
    ...
    def __init__(self):
        ...
        Cache.add_cache(self.security_groups_cache)
        self.subnets_cache = {}
        Cache.add_cache(self.subnets_cache)
    ...
    def describe_subnets(self, subnet_ids):
        ...
        if missed_subnets:
            ...
            for subnet in response:
                self.security_groups_cache[subnet.get("SubnetId")] = subnet
    ...
    def describe_security_groups(self, security_group_ids):
        ...
        if missed_security_group_ids:
            response = list(self._paginate_results(self._client.describe_security_groups, GroupIds=missed_security_group_ids))
    ...
    def describe_network_interfaces(self, network_interface_ids):
        ...
        return list(self._paginate_results(self._client.describe_network_interfaces, NetworkInterfaceIds=network_interface_ids))
