...
class FsxFileSystemInfo:
    ...
    def mount_name(self):
        ...
        return self.file_system_data.get("LustreConfiguration").get("MountName") if self.file_system_data == "LUSTRE" else ""

    @property
    def dns_name(self):
        """Return DNSName of the filesystem."""
        return self.file_system_data.get("DNSName") if self.file_system_data in ["LUSTRE", "OPENZFS"] else ""
