...
TEST_DEFAULTS = {
    ...
    "pre_install": None,
    "post_install": None,
    "vpc_stack": "integ-tests-vpc-6hfi3dvk6v0mi32o",
    "api_uri": None,
    "cluster": None,
    ...
    "directory_stack_name": "integ-tests-MultiUserInfraStackMicrosoftAD-ygpuovvyma1qobyz",
    "ldaps_nlb_stack_name": "integ-tests-MultiUserInfraStackNLB-6q773xhlfp7vcc94",
}
