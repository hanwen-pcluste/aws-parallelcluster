...
def _create_directory_stack(
    cfn_stacks_factory, request, directory_type, test_resources_dir, region, vpc_stack
):
...
def test_ad_integration(
    ...
    config_params.update(
        get_ad_config_param_vals(directory_stack_name, nlb_stack_name, password_secret_arn)
    )
